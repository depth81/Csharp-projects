...
namespace MusicStore.Controllers
{
    public class OrderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,CustomerID,ProductID,OrderNumber,OrderDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,CustomerID,ProductID,OrderNumber,OrderDate")] Order order)
        {
            if (ModelState.IsValid)
            {
